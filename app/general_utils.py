...
class Utils:
   ...
   @classmethod
   def ask_confirmation(cls, confirmation, interactive, dont_exit: bool = True) -> None:
      ...
      if _input == 'y': return
            ...
            if dont_exit:
               console.log("`dont_exit` flag is on. Must be sensitive" 
                           + " data that cant be reverted.", style="red bold")
